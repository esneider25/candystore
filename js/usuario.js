...
// ==========================================
// CandyStore - Panel de Usuario Independiente
// ==========================================
...
.profile-input:focus { border-color: var(--accent); box-shadow: 0 0 0 2px var(--accent-glow); }
    ...
    <div class="user-panel-layout">
      ...
      <aside class="panel-sidebar">
        <!-- CandyStore Brand Identity in User Panel -->
        <div class="logo" style="margin-bottom: 20px; display: flex; align-items: center; justify-content: center; padding-bottom: 20px; border-bottom: 1px solid rgba(255, 255, 255, 0.05);" onclick="navigateTo('home')">
          <span class="logo-icon" style="font-size: 1.8rem; margin-right: 8px;">🍭</span>
          <span class="brand-name" style="font-size: 1.2rem;">CandyStore</span>
        </div>
  ...
  return `
    ...
    <section id="sec-dashboard" class="panel-section active">
      <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 15px; margin-bottom: 24px;">
        <h2 style="font-family: var(--font-display); font-size: 2rem; margin: 0;">Hola, ${currentName || 'CandyStore'} 👋</h2>
        ${roleBadge}
      </div>
    ...
    <section id="sec-support" class="panel-section">
      <div class="glass-card" style="max-width: 800px; margin: 0 auto; height: 600px; display: flex; flex-direction: column; padding: 0; overflow: hidden;">
        <div style="padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); display: flex; align-items: center; gap: 15px;">
          ...
          <div>
            <h3 style="margin: 0; font-size: 1.1rem;">Soporte CandyStore</h3>
